...
export default function Hero() {
  return (
    <section className=" text-white h-[80vh] flex items-center justify-center ">
      <div className="container h-full  flex items-center justify-center ">
        <div className="flex items-center justify-center flex-col px-4 ">
          {/* Títulos */}
          <h1 className="text-3xl md:text-6xl font-bold">Construindo</h1>
          <h2 className="text-5xl md:text-7xl font-bold text-indigo-500 md:mt-2 text-center">
            experiências digitais
          </h2>

          {/* Descrição */}
          <p className="text-[12px] md:text-lg text-gray-300 mt-6 w-[85%] md:max-w-xl mx-auto text-center">
            Ajudando empresas e indivíduos a alcançarem seus objetivos com tecnologia inovadora e
